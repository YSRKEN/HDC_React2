...
const EnemySelector: React.FC<{
	...
	onChangeFinalAttackInputData: (event: React.ChangeEvent<any>) => void,
	...
	formation, criticalPer, onChangeCriticalPer, finalAttackInputData, onChangeFinalAttackInputData }) => (
		<Form className='border p-3'>
			<Form.Group className='mb-0'>
				<div className='d-flex'>
					<Form.Label className="mr-3 text-nowrap mt-1">最終攻撃力</Form.Label>
					<Form.Control placeholder="直接入力する場合" value={finalAttackInputData} onChange={onChangeFinalAttackInputData} />
				</div>
				<div className='d-block d-md-none p-3' style={{
					backgroundColor: finalAttackInputData !== '' ? 'gray' : 'white'
				}}>
					<div className='d-flex'>
				...
				<div className='d-none d-md-block p-3' style={{
					backgroundColor: finalAttackInputData !== '' ? 'gray' : 'white'
				}}>
